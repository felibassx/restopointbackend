export const messageGeneric = {
    ...
    errorMsgInsert: 'Error al crear el registro',
    errorMsgUpdate: 'Error al actualizar el registro',
    errorMsgDelete: 'Error al eliminar el registro',
